    ...
    while($userInput -ne 5)
    {
        ...
        { 
            ...
            2
            {
                ...
                # Timepstamp for the log file
                "TIMESTAMP: "+(Get-Date) | Out-File $outputFiles 
            ...
            3
            {
                ...
                Get-Counter -ListSet *memory* | Select-Object CPU, WS | Out-Host
            }
            4
            {

                # Writes the running processes to the output file
                Get-Process | Sort-Object -Property VirtualSize | Out-GridView
            }
            5
            {
                # Exit 
